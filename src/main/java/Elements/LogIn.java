...
public class LogIn {
    ...
    public SelenideElement continueProcess = $(byXpath("//p[text()='გთხოვთ დაასრულოთ პროცესი']"));
    public SelenideElement closePopupWindow = $(byXpath("//div[@class='header']//div [@class='icon close-black grey-010 pointer']"));
